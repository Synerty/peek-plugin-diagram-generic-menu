from peek_plugin_object_generic_menu._private.server.controller.MainController import \
    MainController
from peek_plugin_object_generic_menu.server.ObjectGenericMenuApiABC import \
    ObjectGenericMenuApiABC


class ObjectGenericMenuApi(ObjectGenericMenuApiABC):
