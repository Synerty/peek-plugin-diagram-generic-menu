...
from peek_plugin_object_generic_menu._private.storage import DeclarativeBase
from peek_plugin_object_generic_menu._private.storage.DeclarativeBase import \
    loadStorageTuples
from peek_plugin_object_generic_menu._private.tuples import loadPrivateTuples
from peek_plugin_object_generic_menu.tuples import loadPublicTuples
from .ObjectGenericMenuApi import ObjectGenericMenuApi
...
class ServerEntryHook(PluginServerEntryHookABC, PluginServerStorageEntryHookABC):
    ...
    def _migrateStorageSchema(self, metadata: MetaData) -> None:
        ...
        renameToObjectSql = '''
            ...
            BEGIN
                ...
                THEN
                  EXECUTE ' DROP SCHEMA IF EXISTS pl_object_generic_menu CASCADE ';
                  EXECUTE ' ALTER SCHEMA pl_diagram_generic_menu RENAME TO pl_object_generic_menu ';
                END IF;
            END
            $$;
        '''
    ...
    def start(self):
        ...
        self._api = ObjectGenericMenuApi(mainController)
