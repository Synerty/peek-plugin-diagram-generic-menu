...
import {SettingPropertyTuple, objectGenericMenuFilt} from "@peek/peek_plugin_object_generic_menu/_private";


@Component({
    selector: 'pl-object-generic-menu-edit-setting',
...
export class EditSettingComponent extends ComponentLifecycleEventEmitter {
    ...
    constructor(private balloonMsg: Ng2BalloonMsgService,
        ...
        this.loader = vortexService.createTupleLoader(this,
            () => extend({}, this.filt, objectGenericMenuFilt));
