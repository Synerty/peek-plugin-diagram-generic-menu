from peek_plugin_generic_diagram_menu._private.server.controller.MainController import \
    MainController
from peek_plugin_generic_diagram_menu.server.GenericDiagramMenuApiABC import \
    GenericDiagramMenuApiABC
