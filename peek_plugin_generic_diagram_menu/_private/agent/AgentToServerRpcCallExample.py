...
from peek_plugin_generic_diagram_menu._private.server.agent_handlers.RpcForAgent import RpcForAgent
...
class AgentToServerRpcCallExample:
    ...
    def run(self):
        ...
        genericDiagramMenu = GenericDiagramMenuTuple(int1=50, string1="Created from Agent RPC")

        d = RpcForAgent.addGenericDiagramMenu(genericDiagramMenu)

        # the deferred will call the lambda function,
        #   "_" will be the result of "addGenericDiagramMenu, which we ignore
